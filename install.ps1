...
if ((scoop bucket list).Name -contains 'extras') {
    Write-Skip "'extras' bucket already added."
} else {
...
# --- 4. Install PSFzf module (for Ctrl+R / Ctrl+T) --------------------------
...
# --- 5. Install the PowerShell profile --------------------------------------
if ($NoProfile) {
